    ...
    DOM.innerHTML = (
        ...
        <div id='container' class=${cx('d-flex-center-max')}>
            ...
            <div class=${cx('d-flex-center-gap-20')}>
                <a href="https://javascript.info/"><img class=${cx('js-image')} src='./src/images/javascript.png' alt='javascript logo'/></a>
                <h1 class=${cx('font-weight-400')}>Standalone - Javascript ES10</h1>
                <a href="https://webpack.js.org/"><img class=${cx('webpack-image')} src='./src/images/webpack.png' alt='webpack logo'/></a>
            </div>
            <div>
